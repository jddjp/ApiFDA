...
namespace SimuladorBackOffice.Models
{
    public class ContratacionLogalty
    {
        ...
        public ContratacionLogalty()
        {
            ...
            //Jose daniel de jesus perez DEV:Certificado logalty y contraseña de archivo .pfx
         certificado = new X509Certificate2("FOMEPADE.pfx", "logalty", X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.Exportable);

            ConnectSetting = new ConnectSetting
            {
                //Aqui apuntamos a DEMO  y a produccion 
                Url = config.UriLGTBUSDemo,
